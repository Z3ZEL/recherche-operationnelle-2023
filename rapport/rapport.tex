...
\begin{table}[h]
  \centering
  \caption[short]{Tableau contenants les résultats des instances pour le premier modèle}
...
\begin{table}[h]
  \centering
  \caption[short]{Tableau contenants les résultats des instances pour le deuxième modèle}
  \resizebox{\columnwidth}{!}{%
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
Nom de l'instance & Relaxation Linéaire & Status de la solution & Valeur de la solution & Rapport en \% & Nombre de noeud & Temps de résolution (s)\\
